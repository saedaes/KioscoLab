...
class AdministratorsControllerTest < ActionController::TestCase
  ...
  test "should create administrator" do
    assert_difference('Administrator.count') do
      post :create, administrator: { direccion: @administrator.direccion, idPuesto: @administrator.idPuesto, nombre: @administrator.nombre, numEmpleado: @administrator.numEmpleado, telefono: @administrator.telefono }
    end
  ...
  test "should update administrator" do
    put :update, id: @administrator, administrator: { direccion: @administrator.direccion, idPuesto: @administrator.idPuesto, nombre: @administrator.nombre, numEmpleado: @administrator.numEmpleado, telefono: @administrator.telefono }
    assert_redirected_to administrator_path(assigns(:administrator))
  end
